...
pub trait Binding: Clone + std::fmt::Debug + PartialEq {
    ...
    /// The code range where the binding is found in the source text.
    ...
    /// Returns the constant this binding applies to, if and only if this is a
    /// constant binding.
