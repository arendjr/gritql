...
#[derive(Debug)]
pub(crate) enum PatternOrResolved<'a, 'b, B: Binding> {
    Pattern(&'a Pattern),
    Resolved(&'b ResolvedPattern<'a, B>),
    ResolvedBinding(ResolvedPattern<'a, B>),
}

#[derive(Debug)]
pub(crate) enum PatternOrResolvedMut<'a, 'b, B: Binding> {
    Pattern(&'a Pattern),
    Resolved(&'b mut ResolvedPattern<'a, B>),
    _ResolvedBinding,
}
